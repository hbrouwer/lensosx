...
extern flag standardSaveWeights(char *fileName, flag binary, int numValues,
                flag thawed, flag frozen);
extern flag standardLoadWeights(char *fileName, flag thawed, flag frozen);
extern flag loadXerionWeights(char *fileName);
