...
proc .showHelp command {
    global .RootDir
    if [file exists ${.RootDir}/user_commands/${command}.txt] {
	uplevel "less ${.RootDir}/user_commands/${command}.txt"
    } else {
